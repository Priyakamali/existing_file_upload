...
<h2>Price List</h2>
<ol class="breadcrumb m-0 align-items-center justify-content-center fs-12 text-white" style="background: transparent;"><li class="breadcrumb-item"><a href="./index.php">Home</a></li><li class="active breadcrumb-item text-white" aria-current="page">Price List</li></ol>
</div>
</div>
<div class="container mb-5">
   <div>
      <iframe src="./doc/asr-agencies-pricelist-2021.pdf" width="100%"
        height="800px"></iframe>
