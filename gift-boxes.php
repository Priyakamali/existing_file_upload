...
<h2>Gift Boxes</h2>
<ol class="breadcrumb m-0 align-items-center justify-content-center fs-12 text-white" style="background: transparent;"><li class="breadcrumb-item"><a href="./index.php">Home</a></li><li class="active breadcrumb-item text-white" aria-current="page">Gift Boxes</li></ol>
</div>
</div>
...
<div class="container mb-5">
  <!-- Gallery -->
      <div class="row">
            <div class="col-lg-3 ">
                <img
                  src="./images/giftbox/Asragengies-Giftboxes-17.jpeg"
                  class="w-100 shadow-1-strong rounded mb-4"
                  alt=""   />
            </div>
            <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-19.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
            </div>
            ...
            <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-21.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
          </div>
          <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-22.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
            </div>
            ...
            <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-11.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
          </div>
          <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-14.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
            </div>
            <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-8.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
            </div>
            <div class="col-lg-3 ">
              <img
                src="./images/giftbox/Asragengies-Giftboxes-23.jpeg"
                class="w-100 shadow-1-strong rounded mb-4"
                alt=""
              />
            </div>
...
<div class="container mb-5">
   <div>
      <object
        data='./doc/giftbox-Pricelist.pdf'
